...
<img src="https://after-school-assets.s3.amazonaws.com/gnome-day.jpg" width="100px" align="right" hspace="10">Once you've gotten all the rspec tests to pass, practice creating instances of the `GardenGnome` class by following these instructions:
